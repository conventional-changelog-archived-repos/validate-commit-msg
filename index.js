...
const IGNORED = new RegExp(`(^WIP)|(^${semverRegex().source}$)`);
...
// fixup! and squash! are part of Git, commits tagged with them are not
// intended to be merged, cf. https://git-scm.com/docs/git-commit
...
function error(msg) {
  ...
  console[config.warnOnFail ? 'warn' : 'error'](`INVALID COMMIT MSG: ${msg}`);
}
