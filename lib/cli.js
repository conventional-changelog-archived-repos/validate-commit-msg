...
if (process.argv.join('').indexOf('mocha') === -1) {
  var arg = process.argv[2],
      isInputFileName = arg && fs.existsSync(gitFolder  + arg),
      ...
      filename = isInputFileName ? arg : 'COMMIT_EDITMSG',
      commitMsgFileOrText = isInputFileName || !arg ? gitFolder + filename : arg;
